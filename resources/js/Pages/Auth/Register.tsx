                    ...
                    <div className="relative z-10 flex w-full flex-col justify-between px-10 py-20 xl:px-16">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="mb-5 flex items-center gap-3 text-[10px] uppercase tracking-[0.3em] text-zinc-600">
                                <span className="h-px w-8 bg-[linear-gradient(90deg,#35dfff,#8b6cff,#f05abf)]" />
                                Create your space
                            </p>
                            ...
                            <h2 className="text-5xl font-semibold leading-[0.92] tracking-[-0.06em] xl:text-6xl">
                                ...
                                a portfolio.
                                <br />
                                <span className="bg-[linear-gradient(100deg,#ffffff,#aab4ba_38%,#ffffff_55%,#35dfff_78%,#d58bff)] bg-clip-text text-transparent">
                                    A home for
                                    <br />
                                    creatives.
                                </span>
                            ...
                            <p className="mt-7 max-w-lg text-sm leading-7 text-zinc-500">
                                Join LIRA and build a creative identity that
                                feels like you. Showcase your work, share your
                                story, and give your audience a place to find
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`h-14 w-full rounded-xl border bg-white/[0.025] pl-12 pr-4 text-sm text-white outline-none transition placeholder:text-zinc-700 focus:bg-white/[0.04] ${
                                                form.errors.name
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`h-14 w-full rounded-xl border bg-white/[0.025] pl-12 pr-12 text-sm text-white outline-none transition placeholder:text-zinc-700 focus:bg-white/[0.04] ${
